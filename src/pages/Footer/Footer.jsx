  ...
  return (
    <footer className="text-white pt-12 pb-6 px-6 md:px-20" style={{ backgroundImage: `url(${fondFooter})`, backgroundSize: "cover", backgroundPosition: "center" }}>
      ...
      <div className="flex flex-col md:flex-row justify-between px-24 text-[17px] footer-responsive">
        <div>
          <h3 className="text-[20px] text-[#444444] font-bold mb-2">Navigation</h3>
          <ul className="space-y-1">
            <li><Link to="/home" className="hover:text-gray-400 transition">Accueil</Link></li>
            <li><Link to="/about" className="hover:text-gray-400 transition">À propos</Link></li>
            <li><Link to="/skills" className="hover:text-gray-400 transition">Compétences</Link></li>
            <li><Link to="/projects" className="hover:text-gray-400 transition">Projets</Link></li>
            <li><Link to="/contact" className="hover:text-gray-400 transition">Contact</Link></li>
          </ul>
        </div>

        <div>
          <h3 className="text-[20px] text-[#444444] font-bold mb-2">Me contacter</h3>
          <ul className="space-y-1">
            <li>
              <a href="/cv.pdf" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 transition">
                <GrDocumentUser className="inline mr-2" />Voir mon CV
              </a>
            </li>
            <li>
      ...
      <div className="mt-10 text-center text-xs text-gray-500">
        © 2025 Noam Joly-Girods. Tous droits réservés.
      </div>
    </footer>
  );
};
